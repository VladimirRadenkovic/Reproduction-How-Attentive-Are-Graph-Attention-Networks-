...
def train1(model, predictor, data, split_edge, optimizer, batch_size):
    model.train()
    predictor.train()
...
def main():
    ...
    data = T.ToSparseTensor()(data) # converts edge_index and edge_weight to sparse tensor adj_t
    ...
    for run in range(args.runs):
        ...
        for epoch in range(1, 1 + args.epochs):
            loss = train1(model, predictor, data, split_edge, optimizer,
                         args.batch_size)
