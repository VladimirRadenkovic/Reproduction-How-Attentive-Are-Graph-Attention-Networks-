...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", dest="task", default=Task.DICTIONARY, type=Task.from_string, choices=list(Task),
                        required=False)
    parser.add_argument("--type", dest="type", default=GNN_TYPE.GATv2, type=GNN_TYPE.from_string, choices=list(GNN_TYPE),
                        required=False)
    ...
    parser.add_argument("--size", dest="size", default=20, type=int, required=False)
